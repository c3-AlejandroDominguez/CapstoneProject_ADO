// TypeScript definitions for the C3 type SmartBulbMeasurementSeries

/**
 * Fill in type description here.
 *
 * @remarks this represents a value passed to a method that expects an instance of SmartBulbMeasurementSeries
 */
declare interface ISmartBulbMeasurementSeries {
  ...
  /**
   * The time zone in which the measurements were taken, represented as an IANA time zone string (e.g., "America/New_York").
   */
  timeZone?: string;
   ...
   */
  data?: Array_Type<SmartBulbMeasurement> | Array<ISmartBulbMeasurement>;
  ...
  /**
   * The smart bulb associated with this measurement series.
   */
  smartBulb: ISmartBulb;

  /**
   * The last status of the smart bulb measurement series.
   */
  lastStatus?: number;
}
 ...
 * Fill in type description here.
 *
 * @remarks this represents a made instance of SmartBulbMeasurementSeries
 */
declare class SmartBulbMeasurementSeries extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): SmartBulbMeasurementSeries;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): SmartBulbMeasurementSeries;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): SmartBulbMeasurementSeries;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): SmartBulbMeasurementSeries;

  /**
   * The interval at which measurements are taken.
   */
  readonly interval?: string;
  withInterval(interval: string | null): SmartBulbMeasurementSeries;

  /**
   * The time zone in which the measurements were taken, represented as an IANA time zone string (e.g., "America/New_York").
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): SmartBulbMeasurementSeries;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): SmartBulbMeasurementSeries;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<SmartBulbMeasurement>;
  withData(data: Array_Type<SmartBulbMeasurement> | Array<ISmartBulbMeasurement> | null): SmartBulbMeasurementSeries;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): SmartBulbMeasurementSeries;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): SmartBulbMeasurementSeries;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): SmartBulbMeasurementSeries;
  ...
  withBucketInterval(bucketInterval: string | null): SmartBulbMeasurementSeries;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): SmartBulbMeasurementSeries;
   ...
   */
  readonly id: string;
  withId(id: string): SmartBulbMeasurementSeries;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SmartBulbMeasurementSeries;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SmartBulbMeasurementSeries;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SmartBulbMeasurementSeries;
  ...
  withVersion(version: number | null): SmartBulbMeasurementSeries;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SmartBulbMeasurementSeries;

  /**
   * The smart bulb associated with this measurement series.
   */
  readonly smartBulb: SmartBulb;
  withSmartBulb(smartBulb: ISmartBulb): SmartBulbMeasurementSeries;

  /**
   * The last status of the smart bulb measurement series.
   */
  readonly lastStatus?: number;
  withLastStatus(lastStatus: number | null): SmartBulbMeasurementSeries;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SmartBulbMeasurementSeries | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SmartBulbMeasurementSeries | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SmartBulbMeasurementSeries | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SmartBulbMeasurementSeries | null;
   ...
   */
  replaceType(old: Type, new_: Type): SmartBulbMeasurementSeries;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SmartBulbMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SmartBulbMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SmartBulbMeasurementSeries>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SmartBulbMeasurementSeries>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SmartBulbMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SmartBulbMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SmartBulbMeasurementSeries;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SmartBulbMeasurementSeries;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SmartBulbMeasurementSeries;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SmartBulbMeasurementSeries;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SmartBulbMeasurementSeries;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SmartBulbMeasurementSeries;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SmartBulbMeasurementSeries;
   ...
   * @see #removeField
   */
  withoutField(field: string): SmartBulbMeasurementSeries;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SmartBulbMeasurementSeries;
   ...
   */
  withoutFields(fields: Array_Type<string>): SmartBulbMeasurementSeries;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SmartBulbMeasurementSeries;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SmartBulbMeasurementSeries;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SmartBulbMeasurementSeries;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SmartBulbMeasurementSeries;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SmartBulbMeasurementSeries;
   ...
   * @see #removeField
   */
  unsetField(field: string): SmartBulbMeasurementSeries;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SmartBulbMeasurementSeries;
   ...
   * @see #unsetField
   */
  removeField(field: string): SmartBulbMeasurementSeries;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SmartBulbMeasurementSeries;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SmartBulbMeasurementSeries;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SmartBulbMeasurementSeries;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SmartBulbMeasurementSeries;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SmartBulbMeasurementSeries;

  mergeJson(json: any): SmartBulbMeasurementSeries;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SmartBulbMeasurementSeries;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SmartBulbMeasurementSeries;
   ...
   */
  singletonArray(): Array_Type<SmartBulbMeasurementSeries>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SmartBulbMeasurementSeries> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SmartBulbMeasurementSeries> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SmartBulbMeasurementSeries>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SmartBulbMeasurementSeries> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SmartBulbMeasurementSeries> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SmartBulbMeasurementSeries> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SmartBulbMeasurementSeries>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SmartBulbMeasurementSeries>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SmartBulbMeasurementSeries;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SmartBulbMeasurementSeries;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SmartBulbMeasurementSeries;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SmartBulbMeasurementSeries;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SmartBulbMeasurementSeries;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SmartBulbMeasurementSeries;
   ...
   * @see #fromString
   */
  static make(s: string): SmartBulbMeasurementSeries | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SmartBulbMeasurementSeries;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SmartBulbMeasurementSeries;
   ...
   */
  static cachedEmptyInst(): SmartBulbMeasurementSeries;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SmartBulbMeasurementSeries> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SmartBulbMeasurementSeries;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<SmartBulbMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<SmartBulbMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<SmartBulbMeasurement>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<SmartBulbMeasurement>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SmartBulbMeasurementSeries>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SmartBulbMeasurementSeries>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SmartBulbMeasurementSeries> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SmartBulbMeasurementSeries>> | null;
   ...
   */
  get(include?: string): SmartBulbMeasurementSeries | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SmartBulbMeasurementSeries | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SmartBulbMeasurementSeries;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SmartBulbMeasurementSeries | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SmartBulbMeasurementSeries;
   ...
   * @see #toString
   */
  static fromString(s: string): SmartBulbMeasurementSeries | null;
   ...
   */
  create(spec?: UpsertSpec): SmartBulbMeasurementSeries | null;
   ...
   */
  static createBatch(objs: Array_Type<SmartBulbMeasurementSeries>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SmartBulbMeasurementSeries>, spec?: CreateBatchObjStreamSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   */
  update(srcObj?: SmartBulbMeasurementSeries, spec?: UpsertSpec): SmartBulbMeasurementSeries | null;
   ...
   */
  upsert(srcObj?: SmartBulbMeasurementSeries, spec?: UpsertSpec): SmartBulbMeasurementSeries | null;
   ...
   */
  merge(spec?: MergeSpec): SmartBulbMeasurementSeries | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SmartBulbMeasurementSeries | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SmartBulbMeasurementSeries | null;
   ...
   */
  static updateBatch(objs: Array_Type<SmartBulbMeasurementSeries>, srcObjs?: Array_Type<SmartBulbMeasurementSeries>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SmartBulbMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SmartBulbMeasurementSeries>, srcObjs?: Array_Type<SmartBulbMeasurementSeries>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SmartBulbMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SmartBulbMeasurementSeries>, spec?: TouchSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SmartBulbMeasurementSeries>, spec?: MergeSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SmartBulbMeasurementSeries>, mergeInclude: string, spec?: MergeSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SmartBulbMeasurementSeries> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   */
  static mergeAll(mergeObj: SmartBulbMeasurementSeries, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SmartBulbMeasurementSeries, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SmartBulbMeasurementSeries>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SmartBulbMeasurementSeries>, spec?: UpsertSpec): ObjList<SmartBulbMeasurementSeries> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SmartBulbMeasurementSeries | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SmartBulbMeasurementSeries>): ObjList<SmartBulbMeasurementSeries>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SmartBulbMeasurementSeries>): ObjList<SmartBulbMeasurementSeries>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SmartBulbMeasurementSeries>): ObjList<SmartBulbMeasurementSeries>;
   ...
   */
  static afterCreate(objs: Array_Type<SmartBulbMeasurementSeries>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SmartBulbMeasurementSeries>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SmartBulbMeasurementSeries>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SmartBulbMeasurementSeries>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SmartBulbMeasurementSeries>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SmartBulbMeasurementSeries | null;
   ...
   */
  withoutIdentity(): SmartBulbMeasurementSeries | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SmartBulbMeasurementSeries>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SmartBulbMeasurementSeries, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SmartBulbMeasurementSeries>, callback?: λFunction<SmartBulbMeasurementSeries | null, SmartBulbMeasurementSeries | null>): ObjList<SmartBulbMeasurementSeries>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SmartBulbMeasurementSeries>, callback?: λFunction<SmartBulbMeasurementSeries | null, SmartBulbMeasurementSeries | null>): Array_Type<ObjError> | null;

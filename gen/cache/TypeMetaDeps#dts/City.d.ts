// TypeScript definitions for the C3 type City

/**
 * Represents a city with smart bulb installations.
 *
 * @remarks this represents a value passed to a method that expects an instance of City
 */
declare interface ICity {
   ...
   */
  buildings?: Array_Type<Building> | Array<IBuilding>;
}
 ...
 */
declare class City extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): City;
  ...
  withVersion(version: number | null): City;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): City;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): City;
  ...
  withHidden(hidden: boolean): City;
  ...
  withUserOwned(userOwned: boolean): City;

  /**
   * The latitude coordinate of the city.
   */
  readonly latitude?: number;
  withLatitude(latitude: number | null): City;

  /**
   * The longitude coordinate of the city.
   */
  readonly longitude?: number;
  withLongitude(longitude: number | null): City;

  /**
   * The electricity rate for the city in dollars per kWh.
   */
  readonly electricityRate?: number;
  withElectricityRate(electricityRate: number | null): City;

  /**
   * The buildings located in this city.
   */
  readonly buildings?: Array_Type<Building>;
  withBuildings(buildings: Array_Type<Building> | Array<IBuilding> | null): City;
   ...
   * @see #toJson
   */
  static fromJson(json: any): City | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): City | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): City | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): City | null;
   ...
   */
  replaceType(old: Type, new_: Type): City;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): City;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): City;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<City>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<City>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): City;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): City;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): City;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): City;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): City;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): City;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): City;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): City;
   ...
   * @see #removeField
   */
  withoutField(field: string): City;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): City;
   ...
   */
  withoutFields(fields: Array_Type<string>): City;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): City;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): City;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): City;
   ...
   * @see #unsetField
   */
  defaultField(field: string): City;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): City;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): City;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): City;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): City;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): City;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): City;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): City;

  mergeJson(json: any): City;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): City;
   ...
   */
  sumObj(other: Obj, deep?: boolean): City;
   ...
   */
  singletonArray(): Array_Type<City>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<City> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<City> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<City>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<City> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, City> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, City> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<City>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<City>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): City;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): City;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): City;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): City;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): City;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): City;
   ...
   * @see #fromString
   */
  static make(s: string): City | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): City;
   ...
   */
  static cachedEmptyInst(): City;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<City> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): City;
   ...
   */
  static allCached(): Stream<City> | null;
   ...
   */
  static find(filter?: string): Stream<City> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<City> | null;
   ...
   */
  static forCacheKey(key: string): City | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<City>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<City>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<City> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<City>> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): City | null;
   ...
   */
  getMissing(spec: GetMissingSpec): City;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): City | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): City;
   ...
   * @see #toString
   */
  static fromString(s: string): City | null;
   ...
   */
  create(spec?: UpsertSpec): City | null;
   ...
   */
  static createBatch(objs: Array_Type<City>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<City>, spec?: CreateBatchObjStreamSpec): ObjList<City> | null;
   ...
   */
  update(srcObj?: City, spec?: UpsertSpec): City | null;
   ...
   */
  upsert(srcObj?: City, spec?: UpsertSpec): City | null;
   ...
   */
  merge(spec?: MergeSpec): City | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): City | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): City | null;
   ...
   */
  static updateBatch(objs: Array_Type<City>, srcObjs?: Array_Type<City>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<City> | null>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<City>, srcObjs?: Array_Type<City>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<City> | null>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<City>, spec?: TouchSpec): ObjList<City> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<City>, spec?: MergeSpec): ObjList<City> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<City>, mergeInclude: string, spec?: MergeSpec): ObjList<City> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<City> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<City> | null;
   ...
   */
  static mergeAll(mergeObj: City, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: City, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<City>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<City>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<City>): ObjList<City>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<City>): ObjList<City>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<City>): ObjList<City>;
   ...
   */
  static afterCreate(objs: Array_Type<City>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<City>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<City>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<City>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<City>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): City | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<City>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: City, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<City>, callback?: λFunction<City | null, City | null>): ObjList<City>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<City>, callback?: λFunction<City | null, City | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): City;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): City | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): City | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<City> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): City | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<City> | null;
  ...
  dependencies(): SeedDataDeps<City> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<City>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<City>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;

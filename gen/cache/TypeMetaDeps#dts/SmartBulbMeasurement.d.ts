// TypeScript definitions for the C3 type SmartBulbMeasurement

/**
 * Fill in type description here.
 *
 * @remarks this represents a value passed to a method that expects an instance of SmartBulbMeasurement
 */
declare interface ISmartBulbMeasurement {
  ...
  parent: ISmartBulbMeasurementSeries;
  ...
  /**
   * The power consumption of the smart bulb at the time of measurement in watts.
   */
  power?: number;

  /**
   * The brightness of the smart bulb at the time of measurement in lumens.
   */
  lumens?: number;

  /**
   * The operating voltage of the smart bulb at the time of measurement in volts.
   */
  voltage?: number;

  /**
   * The operating temperature of the smart bulb at the time of measurement in degrees Celsius.
   */
  temperature?: number;

  /**
   * The operational status code of the smart bulb (e.g., on/off, error states).
   */
  status?: number;
}
 ...
 * Fill in type description here.
 *
 * @remarks this represents a made instance of SmartBulbMeasurement
 */
declare class SmartBulbMeasurement extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): SmartBulbMeasurement;
  ...
  withOutlierCode(outlierCode: number | null): SmartBulbMeasurement;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): SmartBulbMeasurement;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): SmartBulbMeasurement;
  ...
  withDataVersion(dataVersion: number | null): SmartBulbMeasurement;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): SmartBulbMeasurement;

  /**
   * end date for the data point (Only applicable for Interval Timeseries)
   */
  readonly end: DateTime;
  withEnd(end: DateTime | Date | string): SmartBulbMeasurement;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): SmartBulbMeasurement;

  readonly parent: SmartBulbMeasurementSeries;
  withParent(parent: ISmartBulbMeasurementSeries): SmartBulbMeasurement;
   ...
   */
  readonly id: string;
  withId(id: string): SmartBulbMeasurement;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SmartBulbMeasurement;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SmartBulbMeasurement;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SmartBulbMeasurement;
  ...
  withVersion(version: number | null): SmartBulbMeasurement;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SmartBulbMeasurement;

  /**
   * The power consumption of the smart bulb at the time of measurement in watts.
   */
  readonly power?: number;
  withPower(power: number | null): SmartBulbMeasurement;

  /**
   * The brightness of the smart bulb at the time of measurement in lumens.
   */
  readonly lumens?: number;
  withLumens(lumens: number | null): SmartBulbMeasurement;

  /**
   * The operating voltage of the smart bulb at the time of measurement in volts.
   */
  readonly voltage?: number;
  withVoltage(voltage: number | null): SmartBulbMeasurement;

  /**
   * The operating temperature of the smart bulb at the time of measurement in degrees Celsius.
   */
  readonly temperature?: number;
  withTemperature(temperature: number | null): SmartBulbMeasurement;

  /**
   * The operational status code of the smart bulb (e.g., on/off, error states).
   */
  readonly status?: number;
  withStatus(status: number | null): SmartBulbMeasurement;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SmartBulbMeasurement | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SmartBulbMeasurement | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SmartBulbMeasurement | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SmartBulbMeasurement | null;
   ...
   */
  replaceType(old: Type, new_: Type): SmartBulbMeasurement;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SmartBulbMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SmartBulbMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SmartBulbMeasurement>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SmartBulbMeasurement>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SmartBulbMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SmartBulbMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SmartBulbMeasurement;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SmartBulbMeasurement;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SmartBulbMeasurement;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SmartBulbMeasurement;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SmartBulbMeasurement;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SmartBulbMeasurement;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SmartBulbMeasurement;
   ...
   * @see #removeField
   */
  withoutField(field: string): SmartBulbMeasurement;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SmartBulbMeasurement;
   ...
   */
  withoutFields(fields: Array_Type<string>): SmartBulbMeasurement;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SmartBulbMeasurement;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SmartBulbMeasurement;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SmartBulbMeasurement;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SmartBulbMeasurement;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SmartBulbMeasurement;
   ...
   * @see #removeField
   */
  unsetField(field: string): SmartBulbMeasurement;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SmartBulbMeasurement;
   ...
   * @see #unsetField
   */
  removeField(field: string): SmartBulbMeasurement;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SmartBulbMeasurement;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SmartBulbMeasurement;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SmartBulbMeasurement;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SmartBulbMeasurement;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SmartBulbMeasurement;

  mergeJson(json: any): SmartBulbMeasurement;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SmartBulbMeasurement;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SmartBulbMeasurement;
   ...
   */
  singletonArray(): Array_Type<SmartBulbMeasurement>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SmartBulbMeasurement> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SmartBulbMeasurement> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SmartBulbMeasurement>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SmartBulbMeasurement> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SmartBulbMeasurement> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SmartBulbMeasurement> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SmartBulbMeasurement>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SmartBulbMeasurement>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SmartBulbMeasurement;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SmartBulbMeasurement;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SmartBulbMeasurement;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SmartBulbMeasurement;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SmartBulbMeasurement;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SmartBulbMeasurement;
   ...
   * @see #fromString
   */
  static make(s: string): SmartBulbMeasurement | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SmartBulbMeasurement;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SmartBulbMeasurement;
   ...
   */
  static cachedEmptyInst(): SmartBulbMeasurement;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SmartBulbMeasurement> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SmartBulbMeasurement;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): SmartBulbMeasurementSeries | null;
   ...
   */
  static partition(objs?: Stream<SmartBulbMeasurement>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<SmartBulbMeasurement> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SmartBulbMeasurement>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SmartBulbMeasurement>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SmartBulbMeasurement> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SmartBulbMeasurement>> | null;
   ...
   */
  get(include?: string): SmartBulbMeasurement | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SmartBulbMeasurement | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SmartBulbMeasurement;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SmartBulbMeasurement | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SmartBulbMeasurement;
   ...
   * @see #toString
   */
  static fromString(s: string): SmartBulbMeasurement | null;
   ...
   */
  create(spec?: UpsertSpec): SmartBulbMeasurement | null;
   ...
   */
  static createBatch(objs: Array_Type<SmartBulbMeasurement>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SmartBulbMeasurement>, spec?: CreateBatchObjStreamSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   */
  update(srcObj?: SmartBulbMeasurement, spec?: UpsertSpec): SmartBulbMeasurement | null;
   ...
   */
  upsert(srcObj?: SmartBulbMeasurement, spec?: UpsertSpec): SmartBulbMeasurement | null;
   ...
   */
  merge(spec?: MergeSpec): SmartBulbMeasurement | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SmartBulbMeasurement | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SmartBulbMeasurement | null;
   ...
   */
  static updateBatch(objs: Array_Type<SmartBulbMeasurement>, srcObjs?: Array_Type<SmartBulbMeasurement>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SmartBulbMeasurement> | null>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SmartBulbMeasurement>, srcObjs?: Array_Type<SmartBulbMeasurement>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SmartBulbMeasurement> | null>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SmartBulbMeasurement>, spec?: TouchSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SmartBulbMeasurement>, spec?: MergeSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SmartBulbMeasurement>, mergeInclude: string, spec?: MergeSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SmartBulbMeasurement> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   */
  static mergeAll(mergeObj: SmartBulbMeasurement, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SmartBulbMeasurement, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SmartBulbMeasurement>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SmartBulbMeasurement>, spec?: UpsertSpec): ObjList<SmartBulbMeasurement> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SmartBulbMeasurement | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SmartBulbMeasurement>): ObjList<SmartBulbMeasurement>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SmartBulbMeasurement>): ObjList<SmartBulbMeasurement>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SmartBulbMeasurement>): ObjList<SmartBulbMeasurement>;
   ...
   */
  static afterCreate(objs: Array_Type<SmartBulbMeasurement>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SmartBulbMeasurement>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SmartBulbMeasurement>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SmartBulbMeasurement>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SmartBulbMeasurement>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SmartBulbMeasurement | null;
   ...
   */
  withoutIdentity(): SmartBulbMeasurement | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SmartBulbMeasurement>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SmartBulbMeasurement, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SmartBulbMeasurement>, callback?: λFunction<SmartBulbMeasurement | null, SmartBulbMeasurement | null>): ObjList<SmartBulbMeasurement>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SmartBulbMeasurement>, callback?: λFunction<SmartBulbMeasurement | null, SmartBulbMeasurement | null>): Array_Type<ObjError> | null;

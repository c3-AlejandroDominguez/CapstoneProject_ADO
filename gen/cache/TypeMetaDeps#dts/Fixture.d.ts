// TypeScript definitions for the C3 type Fixture

/**
 * Light fixture that a single @link SmartBulb @endlink can be installed into.
 *
 * @remarks this represents a value passed to a method that expects an instance of Fixture
 */
declare interface IFixture {
   ...
   */
  bulbHistory?: Array_Type<SmartBulbToFixtureRelation> | Array<ISmartBulbToFixtureRelation>;

  /**
   * The current bulb installed in this fixture.
   */
  currentBulb?: ISmartBulb;
}
 ...
 */
declare class Fixture extends Obj  {

  /**
   * The unique identifier for this fixture.
   */
  readonly id?: string;
  withId(id: string | null): Fixture;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Fixture;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): Fixture;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Fixture;
  ...
  withVersion(version: number | null): Fixture;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Fixture;

  /**
   * The apartment this fixture is in.
   */
  readonly apartment: Apartment;
  withApartment(apartment: IApartment): Fixture;

  /**
   * The measurements associated with this fixture.
   */
  readonly bulbHistory?: Array_Type<SmartBulbToFixtureRelation>;
  withBulbHistory(bulbHistory: Array_Type<SmartBulbToFixtureRelation> | Array<ISmartBulbToFixtureRelation> | null): Fixture;

  /**
   * The current bulb installed in this fixture.
   */
  readonly currentBulb?: SmartBulb;
  withCurrentBulb(currentBulb: ISmartBulb | null): Fixture;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Fixture | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Fixture | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Fixture | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Fixture | null;
   ...
   */
  replaceType(old: Type, new_: Type): Fixture;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Fixture;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Fixture;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Fixture>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Fixture>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Fixture;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Fixture;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Fixture;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Fixture;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Fixture;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Fixture;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Fixture;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Fixture;
   ...
   * @see #removeField
   */
  withoutField(field: string): Fixture;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Fixture;
   ...
   */
  withoutFields(fields: Array_Type<string>): Fixture;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Fixture;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Fixture;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Fixture;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Fixture;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Fixture;
   ...
   * @see #removeField
   */
  unsetField(field: string): Fixture;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Fixture;
   ...
   * @see #unsetField
   */
  removeField(field: string): Fixture;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Fixture;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Fixture;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Fixture;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Fixture;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Fixture;

  mergeJson(json: any): Fixture;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Fixture;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Fixture;
   ...
   */
  singletonArray(): Array_Type<Fixture>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Fixture> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Fixture> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Fixture>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Fixture> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Fixture> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Fixture> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Fixture>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Fixture>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Fixture;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Fixture;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Fixture;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Fixture;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Fixture;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Fixture;
   ...
   * @see #fromString
   */
  static make(s: string): Fixture | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Fixture;
   ...
   */
  static cachedEmptyInst(): Fixture;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Fixture> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Fixture;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Fixture>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Fixture>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Fixture> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Fixture>> | null;
   ...
   */
  get(include?: string): Fixture | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Fixture | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Fixture;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Fixture | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Fixture;
   ...
   * @see #toString
   */
  static fromString(s: string): Fixture | null;
   ...
   */
  create(spec?: UpsertSpec): Fixture | null;
   ...
   */
  static createBatch(objs: Array_Type<Fixture>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Fixture>, spec?: CreateBatchObjStreamSpec): ObjList<Fixture> | null;
   ...
   */
  update(srcObj?: Fixture, spec?: UpsertSpec): Fixture | null;
   ...
   */
  upsert(srcObj?: Fixture, spec?: UpsertSpec): Fixture | null;
   ...
   */
  merge(spec?: MergeSpec): Fixture | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Fixture | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Fixture | null;
   ...
   */
  static updateBatch(objs: Array_Type<Fixture>, srcObjs?: Array_Type<Fixture>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Fixture> | null>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Fixture>, srcObjs?: Array_Type<Fixture>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Fixture> | null>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Fixture>, spec?: TouchSpec): ObjList<Fixture> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Fixture>, spec?: MergeSpec): ObjList<Fixture> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Fixture>, mergeInclude: string, spec?: MergeSpec): ObjList<Fixture> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Fixture> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Fixture> | null;
   ...
   */
  static mergeAll(mergeObj: Fixture, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Fixture, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Fixture>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Fixture>, spec?: UpsertSpec): ObjList<Fixture> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Fixture>): ObjList<Fixture>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Fixture>): ObjList<Fixture>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Fixture>): ObjList<Fixture>;
   ...
   */
  static afterCreate(objs: Array_Type<Fixture>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Fixture>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Fixture>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Fixture>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Fixture>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Fixture | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Fixture>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Fixture, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Fixture>, callback?: λFunction<Fixture | null, Fixture | null>): ObjList<Fixture>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Fixture>, callback?: λFunction<Fixture | null, Fixture | null>): Array_Type<ObjError> | null;

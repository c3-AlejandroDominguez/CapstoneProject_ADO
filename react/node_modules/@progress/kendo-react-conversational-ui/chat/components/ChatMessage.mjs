...
import { downloadIcon as fe, chevronUpIcon as pe, chevronDownIcon as ge, checkCircleIcon as be, undoIcon as ke, copyIcon as Ce } from "@progress/kendo-svg-icons";
...
const ee = t.forwardRef(
  (i, u) => {
    ...
    const O = t.useCallback((e) => {
      ...
      (e) => {
        var s;
        (s = e.item) != null && s.text && (e.item.data.id === "copy" && !a.isDeleted ? y() : e.item.data.id === "reply" && g(a), v && v(e.item.data, e, a)), D(!1);
      },
      [a, v, g, y]
    ), X = t.useCallback(() => {
      if (a.replyToId) {
        ...
        if (e) {
          const s = (n) => {
            ...
            const E = b == null ? void 0 : b.current;
            Te(e.id, E);
          };
      ...
      return null;
    }, [a.replyToId, L, c, x, b]), Y = t.useCallback(() => {
      const e = [
        {
          id: "reply",
          label: "Reply",
      ...
      if (I) {
        ...
        return /* @__PURE__ */ t.createElement(t.Fragment, null, /* @__PURE__ */ t.createElement(
          ...
          /* @__PURE__ */ t.createElement("div", { className: "k-bubble-content" }, /* @__PURE__ */ t.createElement("span", { className: "k-chat-bubble-text" }, !a.isDeleted && X(), H(x(a, R(c, a)))), a.files && a.files.length > 0 && /* @__PURE__ */ t.createElement(
            Ne,
            {
              files: a.files,
              message: a,
          ...
          m && /* @__PURE__ */ t.createElement(
            ...
            /* @__PURE__ */ t.createElement(j, { icon: C ? pe : ge, size: "medium" })
          )
        ), Y());
      return null;
    }, [
      ...
      let e = null;
      return a.status && l && (T ? e = t.createElement(T, { item: a }) : e = /* @__PURE__ */ t.createElement("span", { className: "k-message-status" }, /* @__PURE__ */ t.createElement(j, { icon: be, size: "xsmall" }), a.status)), e;
      ...
      G,
      {
        ...
        svgIcon: e.svgIcon,
        onClick: (s) => {
          s.stopPropagation(), e.id === "copy" && !a.isDeleted ? y() : e.id === "reply" && g(a), M && M(e, s, a);
        },
